...
To update visual baselines, run CI manually with `update_snapshots` enabled, download the `visual-baselines` artifact, review the images and commit them. Baselines are never accepted or committed automatically.
